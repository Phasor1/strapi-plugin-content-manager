...
const EditViewDataManagerProvider = ({
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      try {
        ...
        strapi.notification.success(config);(`${pluginId}.success.record.save`);
  ...
  const handlePublish = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        strapi.notification.success(config);(`${pluginId}.success.record.publish`);
      } catch (err) {
  ...
  const handleUnpublish = useCallback(async () => {
    try {
      ...
      strapi.notification.success(config);(`${pluginId}.success.record.unpublish`);
    } catch (err) {
      console.error({ err });
      setStatus('resolved');
